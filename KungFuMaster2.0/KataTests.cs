...
namespace KungFuMaster2._0
{
    ...
    {
        [TestMethod, Description("ValidatePin should return false for pins with length other than 4 or 6")]
        ...
        [TestMethod, Description("ValidatePin should return false for pins which contain characters other than digits")]
        ...
        [TestMethod, Description("ValidatePin should return true for valid pins")]
